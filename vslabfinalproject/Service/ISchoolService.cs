...
public interface ISchoolService
{
    ...
    Task<List<StudyTask>> GetStudyTasksAsync(int? studentId = null, string? search = null, string? status = null);
    Task<StudyTask> SaveStudyTaskAsync(StudyTask task);
    Task ToggleStudyTaskCompletionAsync(int id);
    Task DeleteStudyTaskAsync(int id);
}
